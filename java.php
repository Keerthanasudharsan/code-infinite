                  ...
                  <div class="col-sm-12">
                     <div class="tp-breadcrumb__content">
                        <div class="tp-breadcrumb__list course-details mb-70">
                           ...
                           <span style="color:white;">Courses  / Core Java</span>
                        </div>

                        <div class="tp-course-details-2-header">
                           <span class="tp-course-details-2-category">Java Courses</span>
                           <h3 class="tp-course-details-2-title text-white">Core Java</h3>
                           <div class="tp-course-details-2-meta-wrapper d-flex align-items-center flex-wrap">
                              ...
                              <div class="tp-course-details-2-meta">
                                 ...
                                 <h3 class="tp-course-details-2-meta-title text-white">Core Java</h3>
                              </div>
                              <div class="tp-course-details-2-meta">
                        ...
                        <div class="tp-course-details-2-content">
                           <div id="info">
                              ...
                              <div class="tp-course-details-2-text mb-60">
                                 <div class="content">
                                    <p>Learning Java offers a comprehensive foundation in programming and software development. As a versatile and widely-used language, Java provides proficiency in object-oriented principles, enhancing problem-solving and logical thinking skills.</p>
                                    <p>Mastery of Java opens doors to various career opportunities, including roles in enterprise applications, web development, and mobile app development. Additionally, Java's extensive ecosystem and community support offer access to numerous frameworks, tools, and resources, further enriching your development skills and career prospects.</p>
                                   <p> Overall, Java serves as a robust gateway to understanding modern software practices and pursuing advanced technologies. 
                                     </p>
                                 </div>
                              ...
                              <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Introduction to Java</li>
                                    <li><span style="color:blue;"> * </span>Java Features</li>
                                    <li><span style="color:blue;"> * </span>JVM, JRE, and JDK</li>
                                    <li><span style="color:blue;"> * </span>Java Keywords and Data Types</li>
                                    <li><span style="color:blue;"> * </span>Operators</li>
                                    <li><span style="color:blue;"> * </span>Control Flow:</li>
                                    <li><span style="color:blue;"> * </span>Object-Oriented Programming<br> (OOP) Concepts</li>
                                    <li><span style="color:blue;"> * </span>Classes and Objects</li>
                                    <li><span style="color:blue;"> * </span>Methods and Constructors</li>
                                    <li><span style="color:blue;"> * </span>Inheritance</li>
                                    <li><span style="color:blue;"> * </span>Strings and Arrays</li>
                                    <li><span style="color:blue;"> * </span>Exception Handling</li>
                                    <li><span style="color:blue;"> * </span>Collections Framework</li>
                                    <li><span style="color:blue;"> * </span>File Handling and Input/Output <br> (I/O) Operations</li>
                                    <li><span style="color:blue;"> * </span>Advanced Java Concepts</li>
                                    <li><span style="color:blue;"> * </span>Java 8 Features</li>
                                    <li><span style="color:blue;"> * </span>Generics</li>
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">What is Core Java?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              </svg> <i>Reading:</i> Core Java refers to the fundamental features of the Java programming language, including basic syntax, object-oriented programming principles, and core APIs such as collections and I/O. It forms the foundation for developing Java applications and is essential for understanding more advanced Java technologies.</span>
                                             </div>
                                              <div class="right">
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> A basic understanding of programming concepts and familiarity
                                                      with computers is recommended, but the course is suitable for
                                                      beginners as well.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">How can I further advance my Java skills after completing this course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>After completing the course, you can advance your Java skills by exploring advanced topics such as Java frameworks (e.g., Spring, Hibernate), design patterns, data structures, algorithms, and contributing to open-source projects.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">What career paths can I pursue with Core Java knowledge?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Core Java knowledge opens up various career paths, such as Java Developer, Software Engineer, Web Developer, Mobile App Developer, and Backend Developer, among others.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                           ...
                           <h4 class="tp-course-details-2-main-title">Teaching Pattern and Methodologies</h4>
                              <div class="tp-course-details-2-list">
                                 ...
                                 <h4 class="tp-course-details-2-main-title">Benefits of Java Course</h4>
                  ...
                  <div class="col-lg-4">
                     <div class="tp-course-details-2-widget">
                        <div class="tp-course-details-2-widget-thumb p-relative">
                           ...
                           <a class="popup-video" href="https://youtu.be/ipzmkpji_GQ?si=DPq2Ma4GAmUdXqwp"><span><svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="java_full.php"><img class="course-pink" src="assets/img/gif/Full-Stack.jpg" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           ...
                           <h4 class="tp-course-title">
                              <a href="java_full.php">The complete guide to build <br> Full Stack Application</a>
                           </h4>
                        ...
                        <div class="tp-course-btn">
                           <a href="java_full.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
