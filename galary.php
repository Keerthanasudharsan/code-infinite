         ...
         <div class="col-lg-12">
            <div class="tp-campus-choose-wrapper text-center">
               ...
               <div class="tp-campus-choose-content mb-10 wow fadeInUp" data-wow-delay=".5s">
                  <h2 class="tp-campus-choose-title">Our goal is to develop and meet the needs <br> of each child so that he or she becomes a <br> well-rounded tomorrow individual.</h2>
                  <a class="tp-btn" href="about.php">Why Choose Us </a>
               </div>
            </div>
         </div>
         <div class="col-lg-3 col-md-6">
            <div class="tp-campus-choose-thumb text-center mb-30 wow fadeInUp" data-wow-delay=".3s">
               <img src="assets/img/gif/galary/ga1.jpg" alt="">
            </div>
         </div>
         <div class="col-lg-6 col-md-6">
            <div class="tp-campus-choose-thumb-main text-center pt-100 mb-30 wow fadeInUp" data-wow-delay=".5s">
               <img src="assets/img/gif/galary/ga3.jpg" alt="">
            </div>
         </div>
         <div class="col-lg-3 col-md-6">
            <div class="tp-campus-choose-thumb text-center mb-30 wow fadeInUp" data-wow-delay=".7s">
               <img src="assets/img/gif/galary/ga2.jpg" alt="">
            </div>
         </div>
      </div>
   </div>
                  ...
                  <div class="swiper-wrapper align-items-center">
                     ...
                     <div class="swiper-slide">
                        <div class="tp-campus-life-thumb text-center">
                           <img src="assets/img/campus/campus/life-thumb-1.jpg" alt="">
                        </div>
                     </div>
                     <div class="swiper-slide">
                        <div class="tp-campus-life-thumb text-center">
                           <img src="assets/img/campus/campus/life-thumb-2.jpg" alt="">
                        </div>
                     </div>
                     
                     <div class="swiper-slide">
                        <div class="tp-campus-life-thumb text-center">
                           <img src="assets/img/campus/campus/life-thumb-3.jpg" alt="">
                        </div>
                     </div>

                     <div class="swiper-slide">
                        <div class="tp-campus-life-thumb text-center">
                           <img src="assets/img/campus/campus/life-thumb-4.jpg" alt="">
                        </div>
                     </div>
