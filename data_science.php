                  ...
                  <div class="col-sm-12">
                     <div class="tp-breadcrumb__content">
                        <div class="tp-breadcrumb__list course-details mb-70">
                           ...
                           <span style="color:white;">Courses  / Data Science</span>
                        </div>

                        <div class="tp-course-details-2-header">
                           <span class="tp-course-details-2-category">Data Science</span>
                           <h3 class="tp-course-details-2-title text-white">Data Science</h3>
                           <div class="tp-course-details-2-meta-wrapper d-flex align-items-center flex-wrap">
                              ...
                              <div class="tp-course-details-2-meta">
                                 ...
                                 <h3 class="tp-course-details-2-meta-title text-white">Data Science</h3>
                              </div>
                              <div class="tp-course-details-2-meta">
                        ...
                        <div class="tp-course-details-2-content">
                           <div id="info">
                              ...
                              <div class="tp-course-details-2-text mb-60">
                                 <div class="content">
                                    <p>
                                    Data science is an interdisciplinary field that combines statistical analysis, computer science, and domain expertise to extract meaningful insights from complex and often large datasets. It involves the use of advanced tools and techniques, such as machine learning, data mining, and predictive analytics, to identify patterns, trends, and correlations within data.</p>
                                    <p>Data scientists utilize programming languages like Python and R, along with data visualization tools, to interpret and communicate their findings in a way that drives informed decision-making. </p>
                                   <p>  In today’s data-driven world, data science plays a crucial role across various industries, including finance, healthcare, marketing, and technology, enabling organizations to optimize processes, improve outcomes, and gain a competitive edge.
                                     </p>
                                 </div>
                              ...
                              <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Foundations of Data Science</li>
                                    <li><span style="color:blue;"> * </span>Programming for Data Science</li>
                                    <li><span style="color:blue;"> * </span>Statistical Analysis</li>
                                    <li><span style="color:blue;"> * </span>Data Cleaning and Preprocessing</li>
                                    <li><span style="color:blue;"> * </span>Data Visualization</li>
                                    <li><span style="color:blue;"> * </span>Machine Learning</li>
                                    <li><span style="color:blue;"> * </span>Big Data Technologies</li>
                                    <li><span style="color:blue;"> * </span>Data Wrangling</li>
                                    <li><span style="color:blue;"> * </span>Exploratory Data Analysis (EDA)</li>
                                    <li><span style="color:blue;"> * </span>Ethics and Data Privacy</li>
                                    
                                    
                                 </ul>
                                 <p>By the end of the course, you will be well-equipped with the knowledge and practical experience to work as a data scientist, capable of solving complex problems and driving data-driven decision-making in various industries.</p>
                              </div>
                           </div>
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">What prerequisites do I need before enrolling in a Data Science course?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              </svg> <i>Reading:</i> A basic understanding of programming (preferably Python or R), statistics, and mathematics is usually required. Familiarity with data analysis tools like Excel can also be helpful.</span>
                                             </div>
                                              <div class="right">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What topics will be covered in the Data Science course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> The Data Science course at Code Infinite will cover key topics such as data wrangling, statistical analysis, machine learning, data visualization, big data technologies, and real-world project work. This comprehensive curriculum ensures that students gain the necessary skills to excel in the data science field.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">Will I get hands-on experience with real-world projects during the course?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Yes, the course at Code Infinite includes practical exercises and projects that simulate real-world scenarios to help you apply what you've learned.
                                               </span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">Do you provide any study materials or resources for this course?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Yes, students at Code Infinite will receive comprehensive study materials, including slides, code samples, and access to online resources.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              Yes, Code Infinite provides a certificate of completion after successfully finishing the course, which can enhance your resume and demonstrate your expertise in Django development.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">How long is the Data Science course, and what is the format?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> The duration of the Data Science course at Code Infinite typically ranges from 3 to 6 months, depending on the intensity and format. It can be offered online, in-person, or as a hybrid of both, providing flexibility to accommodate different learning preferences.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">Will there be any hands-on projects or assignments?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Yes, the course at Code Infinite includes practical exercises, assignments, and projects to help you apply what you’ve learned and gain practical experience.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What is the mode of instruction?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>Classes at Code Infinite are usually conducted in a combination of lectures, hands-on coding sessions, group activities, and discussions, with both online and in-person formats.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">What career opportunities can I pursue after completing the Data Science course?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Graduates can pursue roles such as Data Scientist, Data Analyst, Machine Learning Engineer, Business Analyst, or Data Engineer in various industries like finance, healthcare, technology, and more.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                           ...
                           <div id="instructors" class="pt-100">
                              ...
                              <div class="tp-course-details-2-instructor d-flex">
                                 ...
                                 <img src="assets/img/gif/tt copy.jpg" style="border:1px solid white; border-radius: 50%; " alt="">
                                 </div>
                                 <div class="tp-course-details-2-instructor-content">
                                    <h5>Mohamadhu Azarutheen </h5>
                                    <span class="pre">Data Science Trainer</span>
                                    ...
                                    <div class="tp-course-details-2-instructor-text">
                                       <p>Mohamadhu Azarutheen is a talented and dedicated young trainer specializing in full stack Python development with Django. With a solid educational background in Computer Science and practical experience in the tech industry, Mohamadhu brings a wealth of knowledge and enthusiasm to his teaching.</p>
                                      
                                       <h5>Skills</h5>
                                       <p>- Programming Languages: Python, C, C++, JavaScript</p>
                                       <p>- Frameworks: Django, Django REST Framework</p>
                                       <p>- Front-end Technologies: HTML, CSS, Bootstrap, React</p>
                                       <p>- Databases: MySQL</p>
                                       <p>- Web Technologies: RESTful APIs, Git</p>
                                    </div>
                           ...
                           <h4 class="tp-course-details-2-main-title">Teaching Pattern and Methodologies</h4>
                              <div class="tp-course-details-2-list">
                                 ...
                                 <p>Data science is widely used across various industries and fields to drive decision-making, optimize processes, and create innovative solutions.</p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Business Analytics</li>
                                    <li><span style="color:blue;"> * </span>Healthcare</li>
                                    <li><span style="color:blue;"> * </span> Finance</li>
                                    <li><span style="color:blue;"> * </span>E-commerce</li>
                                    <li><span style="color:blue;"> * </span> Manufacturing</li>
                                    <li><span style="color:blue;"> * </span> Retail</li>
                                    <li><span style="color:blue;"> * </span>Transportation and Logistics</li>
                                    <li><span style="color:blue;"> * </span>Social Media and Content Platforms</li>
                                    <li><span style="color:blue;"> * </span>Education</li>
                                    <li><span style="color:blue;"> * </span>Sports Analytics</li>
                                   
                                    
                                 </ul>
                              </div>
                              <h4 class="tp-course-details-2-main-title">Students Outcome</h4>
                                 <p>If you completed this course what will you gain from this Data Science course.</p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Proficiency in Data Science Concepts</li>
                                    <li><span style="color:blue;"> * </span>Programming Skills</li>
                                    <li><span style="color:blue;"> * </span>Statistical Analysis Expertise</li>
                                    <li><span style="color:blue;"> * </span>Machine Learning Knowledge</li>
                                    <li><span style="color:blue;"> * </span>Data Visualization Skills</li>
                                    <li><span style="color:blue;"> * </span>Big Data Technologies Exposure</li>
                                    <li><span style="color:blue;"> * </span>Real-World Project Experience</li>
                                    <li><span style="color:blue;"> * </span>Data Wrangling and Preprocessing</li>
                                    <li><span style="color:blue;"> * </span>Communication Skills</li>
                           ...
                           <div class="tp-course-details-2-review-reply-wrap">
                              <div class="tp-course-details-2-review-item-reply">
                                 ...
                                 <p>Hi iam nithis from tirupur I have joined Java course in code infinite.the training methods is good I feel improvement in coding. good infrastructure and it's so comfortable class. I strongly suggest to any one "code infinite is best institute for java programming". My trainer Mansoor was so kind, explain the concepts easy way to understand.</p>
                              ...
                              <div class="tp-course-details-2-review-item-reply">
                                 ...
                                 <p>Hello everyone , I am Dharshan I had completed my core Java , c programming class in code infinite IT training institute located in saravanampatti. "it had help me lot in my college during classes and practical exam." The complete Java course is help me to developing my skills.</p>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="python_full.php"><img class="course-pink" src="assets/img/gif/python_full.jpeg" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           ...
                           <h4 class="tp-course-title">
                              <a href="python_full.php">The complete guide to build <br> Full Stack Application</a>
                           </h4>
                        ...
                        <div class="tp-course-btn">
                           <a href="python_full.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="django.php"><img class="course-sky" src="assets/img/gif/django.png" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           <div class="tp-course-tag mb-10">
                              <span>Django</span>
                        ...
                        <div class="tp-course-btn">
                           <a href="django.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="python.php"><img class="course-lightblue" src="assets/img/gif/core_py.jpg" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           <div class="tp-course-tag mb-10">
                           ...
                           <h4 class="tp-course-title">
                              <a href="python.php">Core Python</a>
                           </h4>
                           <div class="tp-course-rating d-flex align-items-end justify-content-between">
                              <div class="tp-course-rating-star">
                                 <p>5.0<span> /5</span></p>
                        ...
                        <div class="tp-course-btn">
                           <a href="python.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
               </div>
