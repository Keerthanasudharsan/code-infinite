                  ...
                  <div class="col-sm-12">
                     <div class="tp-breadcrumb__content">
                        <div class="tp-breadcrumb__list course-details mb-70">
                           ...
                           <span style="color:white;">Courses  / Django</span>
                        </div>

                        <div class="tp-course-details-2-header">
                           <span class="tp-course-details-2-category">Django</span>
                           <h3 class="tp-course-details-2-title text-white">Django</h3>
                           <div class="tp-course-details-2-meta-wrapper d-flex align-items-center flex-wrap">
                              ...
                              <div class="tp-course-details-2-meta">
                                 ...
                                 <h3 class="tp-course-details-2-meta-title text-white">Django</h3>
                              </div>
                              <div class="tp-course-details-2-meta">
                        ...
                        <div class="tp-course-details-2-content">
                           <div id="info">
                              ...
                              <div class="tp-course-details-2-text mb-60">
                                 <div class="content">
                                    <p>Django is a high-level web framework for Python that encourages rapid development and clean, pragmatic design. It follows the "batteries-included" philosophy, providing developers with a comprehensive set of tools and features to build web applications efficiently.</p>
                                    <p>Django emphasizes reusability and the "Don't Repeat Yourself" (DRY) principle, allowing developers to create modular applications by leveraging its robust component architecture. With built-in features like an ORM (Object-Relational Mapping), authentication system, and an administrative interface, Django simplifies common web development tasks such as database management, user authentication, and URL routing.  </p>
                                   <p>  Its strong community support and extensive documentation make it an ideal choice for both beginners and experienced developers looking to create scalable, secure, and maintainable web applications quickly.
                                     </p>
                                 </div>
                              ...
                              <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Django Framework Overview</li>
                                    <li><span style="color:blue;"> * </span>Setting Up the Environment</li>
                                    <li><span style="color:blue;"> * </span>Creating Django Projects</li>
                                    <li><span style="color:blue;"> * </span>URL Routing</li>
                                    <li><span style="color:blue;"> * </span>Views and Templates</li>
                                    <li><span style="color:blue;"> * </span>Working with Models</li>
                                    <li><span style="color:blue;"> * </span>Forms and User Input</li>
                                    <li><span style="color:blue;"> * </span>Authentication and Authorization</li>
                                    <li><span style="color:blue;"> * </span>Admin Interface Customization</li>
                                    <li><span style="color:blue;"> * </span>Testing and Debugging</li>
                                    
                                    
                                 </ul>
                                 <p>With this course,you will have the knowledge and practical experience to develop robust, scalable web applications using Django, making you well-prepared for roles in web development.</p>
                              </div>
                           </div>
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">What prerequisites do I need before enrolling in a Django course?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              </svg> <i>Reading:</i> A basic understanding of Python programming is usually required, along with familiarity with web development concepts. Prior experience with HTML, CSS, and JavaScript will also be beneficial.</span>
                                             </div>
                                              <div class="right">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What topics will be covered in the Django course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> The Django course at Code Infinite will cover key components, including models, views, templates, URL routing, forms, authentication, RESTful APIs, and deployment, along with practical projects. This comprehensive curriculum ensures that students gain the necessary skills to develop robust web applications using Django.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">How long is the Django course, and what is the format?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> The duration of the Django course at Code Infinite typically ranges from 4 to 8 weeks, with a mix of lectures, hands-on labs, and project work. The format may be online, in-person, or a hybrid of both, offering flexibility to suit different learning preferences.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">What career opportunities can I pursue after completing the Django course?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Upon completion, you can pursue roles such as Django Developer, Web Developer, Software Engineer, or Full-Stack Developer, as well as opportunities in backend development.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                           ...
                           <div id="instructors" class="pt-100">
                              ...
                              <div class="tp-course-details-2-instructor d-flex">
                                 ...
                                 <div class="tp-course-details-2-instructor-content">
                                    ...
                                    <span class="pre">Full Stack Python Trainer</span>
                           ...
                           <h4 class="tp-course-details-2-main-title">Teaching Pattern and Methodologies</h4>
                              <div class="tp-course-details-2-list">
                                 ...
                                 <h4 class="tp-course-details-2-main-title">Benefits Django Course</h4>
                                 <p>Django is widely used for developing web applications due to its robust features, scalability, and ease of use.</p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Web Application Development</li>
                                    <li><span style="color:blue;"> * </span>RESTful APIs</li>
                                    <li><span style="color:blue;"> * </span> Enterprise Applications</li>
                                    <li><span style="color:blue;"> * </span>Prototyping and MVPs</li>
                                    <li><span style="color:blue;"> * </span> Data-Driven Applications</li>
                                    <li><span style="color:blue;"> * </span> Scientific Computing</li>
                                    <li><span style="color:blue;"> * </span>Blogging and Publishing Platforms</li>
                                    <li><span style="color:blue;"> * </span>Educational Platforms</li>
                                    <li><span style="color:blue;"> * </span>E-commerce Websites</li>
                                    <li><span style="color:blue;"> * </span>Community and Social Platforms</li>
                                   
                                    
                                 </ul>
                              </div>
                              <h4 class="tp-course-details-2-main-title">Students Outcome</h4>
                                 <p>If you completed this course what will you gain from this Django course.</p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Proficiency in Django Framework</li>
                                    <li><span style="color:blue;"> * </span>Web Application Development Skills</li>
                                    <li><span style="color:blue;"> * </span>Database Management</li>
                                    <li><span style="color:blue;"> * </span>RESTful API Development</li>
                                    <li><span style="color:blue;"> * </span>Authentication and Security</li>
                                    <li><span style="color:blue;"> * </span>Testing and Debugging</li>
                                    <li><span style="color:blue;"> * </span>Deployment and Scaling</li>
                                    <li><span style="color:blue;"> * </span>Custom Admin Interfaces</li>
                                    <li><span style="color:blue;"> * </span>Project Management Experience</li>
                           ...
                           <div class="tp-course-details-2-review-reply-wrap">
                              ...
                              <div class="tp-course-details-2-review-item-reply">
                                 ...
                                 <p>Hello everyone, Im Mohamed sharif I thought to learn Python programming course, i found code infinite it training institue. "the overall experience is so good, i strongly suggest to any students code infinite is the best it training institue".</p>
               ...
               <div class="row">
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="python.php"><img class="course-pink" src="assets/img/gif/core_py.jpg" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           ...
                           <h4 class="tp-course-title">
                              <a href="python.php">The complete guide to build <br> Full Stack Application</a>
                           </h4>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="python_full.php"><img class="course-sky" src="assets/img/gif/python_full.jpeg" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           <div class="tp-course-tag mb-10">
                           ...
                           <h4 class="tp-course-title">
                              <a href="python_full.php">Full Stack Python</a>
                           </h4>
                           <div class="tp-course-rating d-flex align-items-end justify-content-between">
                              <div class="tp-course-rating-star">
                                 <p>5.0<span> /5</span></p>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="data_science.php"><img class="course-lightblue" src="assets/img/gif/data_science_using_python.jpg" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           <div class="tp-course-tag mb-10">
                        ...
                        <div class="tp-course-btn">
                           <a href="data_science.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
               </div>
