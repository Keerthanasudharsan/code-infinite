                  ...
                  <div class="col-sm-12">
                     <div class="tp-breadcrumb__content">
                        <div class="tp-breadcrumb__list course-details mb-70">
                           ...
                           <span style="color:white;">Courses  / Mern Stack</span>
                        </div>

                        <div class="tp-course-details-2-header">
                           <span class="tp-course-details-2-category">Mern Stack</span>
                           <h3 class="tp-course-details-2-title text-white">Mern Stack</h3>
                           <div class="tp-course-details-2-meta-wrapper d-flex align-items-center flex-wrap">
                              ...
                              <div class="tp-course-details-2-meta">
                                 ...
                                 <h3 class="tp-course-details-2-meta-title text-white">Mern Stack</h3>
                              </div>
                              <div class="tp-course-details-2-meta">
                        ...
                        <div class="tp-course-details-2-content">
                           <div id="info">
                              ...
                              <div class="tp-course-details-2-text mb-60">
                                 <div class="content">
                                    ...
                                    <p>The MERN stack is a powerful, full-stack JavaScript solution for developing modern web applications. It comprises four main technologies: MongoDB for the database, providing a flexible, document-oriented data structure; Express.js as the backend framework, streamlining server-side development with robust APIs and middleware; React for the front-end, enabling developers to build dynamic, interactive user interfaces with reusable components; and Node.js as the runtime environment, allowing JavaScript to be used for server-side scripting.</p>
                                   <p>Together, these technologies create a seamless development experience, enabling developers to build scalable, high-performance applications using a single programming language, JavaScript, across both the front and back ends.
                                     </p>
                                 </div>
                              ...
                              <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>MongoDB</li>
                                    <li><span style="color:blue;"> * </span>Express.js</li>
                                    <li><span style="color:blue;"> * </span>React</li>
                                    <li><span style="color:blue;"> * </span>Node.js</li>
                                    <li><span style="color:blue;"> * </span> RESTful APIs</li>
                                    <li><span style="color:blue;"> * </span>Middleware</li>
                                    <li><span style="color:blue;"> * </span>Component-Based Architecture</li>
                                    <li><span style="color:blue;"> * </span>State Management</li>
                                    <li><span style="color:blue;"> * </span>Hooks</li>
                                    <li><span style="color:blue;"> * </span>Version Contro</li>
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">What prior knowledge or skills do I need before starting the MERN stack course?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              </svg> <i>Reading:</i>  Ideally, you should have a basic understanding of JavaScript, HTML, and CSS. Familiarity with programming concepts and basic web development will be beneficial. If you're new to these areas, some introductory courses or self-study in these topics can help prepare you.</span>
                                             </div>
                                              <div class="right">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">How much time will it take to complete the course, and what is the expected workload?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> The duration of the course can vary, but most MERN stack courses are designed to be completed in 8 to 12 weeks if you're studying part-time. Expect a combination of lectures, coding exercises, and projects, with a workload that might require 10-15 hours per week..</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">Will there be hands-on projects or real-world examples included in the course?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>Yes, the course typically includes hands-on projects and real-world examples. You'll work on building practical applications using the MERN stack, which helps reinforce the concepts learned and provides valuable experience for your portfolio.
                                               </span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">How does this course prepare me for a career in full-stack development?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> The course provides comprehensive training in both front-end and back-end development using the MERN stack. You'll learn to build and integrate both parts of a web application, which is essential for a full-stack developer role. The projects and practical experience also help in building a strong portfolio to showcase to potential employers.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What kind of support or resources are available if I encounter difficulties during the course?</span>
                                          <span class="lesson">90 days duration</span>
                                          <span class="accordion-btn"></span>
                                        </button>
                                      </h2>
                                      <div id="panelsStayOpen-collapseTwo" class="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingTwo">
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>Most courses offer various forms of support, such as access to instructors for questions, peer support through forums or study groups, and additional resources like documentation, tutorials, and sample code. Some may also provide one-on-one mentoring or office hours.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">Will this course cover deployment and version control tools like Git and Heroku?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Yes, the course usually includes sections on deployment and version control. You’ll learn how to use Git for version control and platforms like Heroku or AWS for deploying your applications, which are essential skills for real-world development.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">How in-depth will the course go into each component of the MERN stack, especially React and Node.js?</span>
                                          <span class="lesson">90 Days Duration</span>
                                          <span class="accordion-btn"></span>
                                       </button>
                                      </h2>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Yes, the course at Code Infinite includes practical exercises, assignments, and projects to help you apply what you’ve learned and gain practical experience.The course covers each component of the MERN stack in depth. You’ll delve into MongoDB for database management, Express.js for server-side logic, React for building interactive user interfaces, and Node.js for server-side JavaScript execution. Each component is explored thoroughly to ensure you have a solid understanding of how they work together.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">Are there any industry certifications or recognized credentials provided upon completion of the course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>While some courses offer certificates of completion, industry-recognized certifications are not always provided. However, completing the course will give you practical experience and skills that are highly valued by employers. Some courses also offer guidance on obtaining relevant certifications or creating a portfolio to showcase your skills.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                           ...
                           <h4 class="tp-course-details-2-main-title">Teaching Pattern and Methodologies</h4>
                              <div class="tp-course-details-2-list">
                                 ...
                                 <h4 class="tp-course-details-2-main-title">Benefits of Mern Stack Course</h4>
                                 <p>The MERN stack offers several benefits for web development, making it a popular choice among developers</p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    ...
                                    <li><span style="color:blue;"> * </span> Real-Time Data Processing</li>
                                    <li><span style="color:blue;"> * </span>Rapid Development</li>
                                    <li><span style="color:blue;"> * </span>Single Page Applications </li>
                           ...
                           <div class="tp-course-details-2-review-reply-wrap">
                              <div class="tp-course-details-2-review-item-reply">
                                 ...
                                 <p>Fantastic traning centre for programming language and mobile app development ,awesome training for mansoor sir and team thanks and lot
                                 </p>
                              ...
                              <div class="tp-course-details-2-review-item-reply">
                                 ...
                                 <p>It is a perfect place for the begginers, they take special care for each individual,guide up in a right way ,At the end of the course you have a clear view about the courses,thanks for the guidance subha mam and mansoor bro</p>
