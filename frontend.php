                  ...
                  <div class="col-sm-12">
                     <div class="tp-breadcrumb__content">
                        <div class="tp-breadcrumb__list course-details mb-70">
                           ...
                           <span style="color:white;">Courses  / Front-end & Php</span>
                        </div>

                        <div class="tp-course-details-2-header">
                           <span class="tp-course-details-2-category"> Front-end & Php</span>
                           <h3 class="tp-course-details-2-title text-white"> Front-end & Php</h3>
                           <div class="tp-course-details-2-meta-wrapper d-flex align-items-center flex-wrap">
                              ...
                              <div class="tp-course-details-2-meta">
                                 ...
                                 <h3 class="tp-course-details-2-meta-title text-white"> Front-end & Php</h3>
                              </div>
                              <div class="tp-course-details-2-meta">
                        ...
                        <div class="tp-course-details-2-content">
                           <div id="info">
                              ...
                              <div class="tp-course-details-2-text mb-60">
                                 <div class="content">
                                    <p>
                                    Front-end development is a crucial aspect of web development that focuses on creating the visual and interactive elements of a website or web application that users directly engage with. It involves using languages like HTML, CSS, and JavaScript to build and style user interfaces, ensuring that they are aesthetically pleasing, functional, and responsive across various devices and screen sizes.</p>
                                    <p> . Front-end developers use frameworks and libraries such as React, Angular, or Vue.js to streamline development and enhance the user experience.   </p>
                                   <p> They work closely with designers and back-end developers to translate design concepts into code and integrate front-end elements with back-end functionality. The goal of front-end development is to deliver a seamless and intuitive user experience that aligns with the needs and expectations of the target audience.
                                     </p>
                                 </div>
                              ...
                              <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>HTML</li>
                                    <li><span style="color:blue;"> * </span>CSS</li>
                                    <li><span style="color:blue;"> * </span>JavaScrip</li>
                                    <li><span style="color:blue;"> * </span>Front-End php Frameworks </li>
                                    <li><span style="color:blue;"> * </span>Responsive Design</li>
                                    <li><span style="color:blue;"> * </span>Version Control</li>
                                    <li><span style="color:blue;"> * </span>Web Performance Optimization</li>
                                    <li><span style="color:blue;"> * </span>Cross-Browser Compatibility</li>
                                    <li><span style="color:blue;"> * </span>User Experience (UX) Design</li>
                                    <li><span style="color:blue;"> * </span>Web Accessibility</li>
                                    <li><span style="color:blue;"> * </span>Front-End Build Tools</li>
                                    <li><span style="color:blue;"> * </span>API Integration</li>
                                    <li><span style="color:blue;"> * </span>Debugging and Testing</li>
                                    
                                    
                                 </ul>
                                 <p>By the end of the course, you'll have the skills to build and maintain modern, responsive, and interactive websites and applications, preparing you for a career as a front-end developer.</p>
                              </div>
                           </div>
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">What prerequisites are required for a Front-End Development course?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              </svg> <i>Reading:</i> Basic computer skills and familiarity with using the internet are generally required. Prior knowledge of HTML, CSS, or JavaScript is helpful but not mandatory, as many courses start with the fundamentals.</span>
                                             </div>
                                              <div class="right">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What topics will be covered in the Front-End Development course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> The Front-End Development course at Code Infinite will cover HTML, CSS, JavaScript, front-end frameworks (like React, php), responsive design, version control with Git, web performance optimization, cross-browser compatibility, and web accessibility.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">How long is the Front-End Development course, and what is the format?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> The Front-End Development course at Code Infinite typically ranges from a few weeks to several months, depending on the intensity and format. The course can be offered online, in-person, or as a hybrid of both.
                                               </span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What career opportunities are available after completing the course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              Graduates can pursue roles such as Front-End Developer, Web Designer, UI/UX Designer, or even Full-Stack Developer in various industries including technology, e-commerce, and digital marketing.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> The Front-End Development course at Code Infinite typically includes hands-on projects such as building personal portfolios, landing pages, interactive web applications, and responsive websites, providing practical experience in real-world scenarios.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What tools and technologies will I learn to use in the course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>You will learn to use tools and technologies such as HTML, CSS, JavaScript, front-end frameworks (e.g., React, Angular, Vue.js), Git for version control, and various build tools and task runners.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Assessment methods typically include quizzes, assignments, practical projects, and possibly a final exam or project that demonstrates your understanding and application of course material.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                           ...
                           <div id="instructors" class="pt-100">
                              ...
                              <div class="tp-course-details-2-instructor d-flex">
                                 ...
                                 <div class="tp-course-details-2-instructor-content">
                                    ...
                                    <span class="pre">Mearn Stack</span>
                                    ...
                                    <div class="tp-course-details-2-instructor-text">
                                       <p>Mohamadhu Azarutheenis a proficient web_development trainer with a strong foundation in programming languages and frameworks. With a keen interest in fostering a passion for coding, Mohamadhu Azarutheen brings a blend of practical experience and theoretical knowledge to his teaching.</p>
                           ...
                           <h4 class="tp-course-details-2-main-title">Teaching Pattern and Methodologies</h4>
                              <div class="tp-course-details-2-list">
                                 ...
                                 <p>A Front-End Development course equips students with the skills to create the visible parts of websites and web applications that users interact with directly. </p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Building Websites</li>
                                    <li><span style="color:blue;"> * </span>Creating Web Applications</li>
                                    <li><span style="color:blue;"> * </span>Improving User Experience (UX)</li>
                                    <li><span style="color:blue;"> * </span>Designing Responsive Layouts</li>
                                    <li><span style="color:blue;"> * </span>Implementing Web Standards and Best Practices</li>
                                    <li><span style="color:blue;"> * </span>Enhancing Website Performance</li>
                                    <li><span style="color:blue;"> * </span>Using Modern Front-End Technologies</li>
                                    <li><span style="color:blue;"> * </span>Version Control and Collaboration</li>
                                    <li><span style="color:blue;"> * </span>Freelancing and Entrepreneurship</li>
                              ...
                              <h4 class="tp-course-details-2-main-title">Students Outcome</h4>
                                 <p>If you completed this course what will you gain from this Front-End course.</p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Proficiency in Core Technologies</li>
                                    <li><span style="color:blue;"> * </span>Advanced Front-End Framework Skills</li>
                                    <li><span style="color:blue;"> * </span>Responsive Web Design Expertise</li>
                                    <li><span style="color:blue;"> * </span>Version Control Knowledge</li>
                                    <li><span style="color:blue;"> * </span>Web Performance Optimization</li>
                                    <li><span style="color:blue;"> * </span>Cross-Browser Compatibility</li>
                                    <li><span style="color:blue;"> * </span>User Experience (UX) Design Skills</li>
                                    <li><span style="color:blue;"> * </span>Web Accessibility Knowledge</li>
                                    <li><span style="color:blue;"> * </span>Practical Project Experience</li>
                           ...
                           <div class="tp-course-details-2-review-reply-wrap">
                              <div class="tp-course-details-2-review-item-reply">
                                 ...
                                 <p>It's a best place to start ur professional learning... patient and skilleds trainers who can mould a good career...overall a best institution for learning with hands on experience</p>
                              ...
                              <div class="tp-course-details-2-review-item-reply">
                                 ...
                                 <p>Best training institute in cbe...staffs are very talented and teaching very well...very responsive and clearing doubts quickly... Best institute for job seekers</p>
               ...
               <div class="row">
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="web_development.php"><img class="course-sky" src="assets/img/gif/course3.jpg" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           <div class="tp-course-tag mb-10">
                        ...
                        <div class="tp-course-btn">
                           <a href="web_development.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
