                  ...
                  <div class="col-sm-12">
                     <div class="tp-breadcrumb__content">
                        <div class="tp-breadcrumb__list course-details mb-70">
                           ...
                           <span style="color:white;">Courses  /Java Full Stack</span>
                        </div>

                        <div class="tp-course-details-2-header">
                           <span class="tp-course-details-2-category">Full Stack Courses</span>
                           <h3 class="tp-course-details-2-title text-white"> Java Full Stack</h3>
                           <div class="tp-course-details-2-meta-wrapper d-flex align-items-center flex-wrap">
                              ...
                              <div class="tp-course-details-2-meta">
                                 ...
                                 <h3 class="tp-course-details-2-meta-title text-white">Java Full Stack</h3>
                              </div>
                              <div class="tp-course-details-2-meta">
                        ...
                        <div class="tp-course-details-2-content">
                           <div id="info">
                              ...
                              <div class="tp-course-details-2-text mb-60">
                                 <div class="content">
                                   ...
                                   <p>A Java Full Stack Developer is a software professional proficient in both front-end and back-end development using Java as the core programming language. On the back-end, they work with Java frameworks such as Spring and Hibernate to build robust and scalable server-side applications, manage databases, and implement APIs.</p>
                                   
                                   <p>On the front-end, they typically use technologies like HTML, CSS, JavaScript, and frameworks such as Angular or React to create dynamic and responsive user interfaces. Java Full Stack Developers are versatile, capable of handling all layers of an application, from designing the user experience to managing the business logic and data storage.</p>
                                    <p> Their comprehensive skill set makes them valuable in building end-to-end solutions, ensuring seamless integration between the client-side and server-side components of web applications.
                                     </p>
                                 </div>
                              ...
                              <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Core Java Programming</li>
                                    <li><span style="color:blue;"> * </span>Java Features</li>
                                    <li><span style="color:blue;"> * </span>JVM, JRE, and JDK</li>
                                    <li><span style="color:blue;"> * </span>Object-Oriented Programming (OOP)</li>
                                    <li><span style="color:blue;"> * </span>Java Syntax and Basics</li>
                                    <li><span style="color:blue;"> * </span>Collections Framework</li>
                                    <li><span style="color:blue;"> * </span>Spring Framework</li>
                                    <li><span style="color:blue;"> * </span>RESTful Services</li>
                                    <li><span style="color:blue;"> * </span>Database Management</li>
                                    <li><span style="color:blue;"> * </span>Front-End Development</li>
                                    <li><span style="color:blue;"> * </span>HTML</li>
                                    <li><span style="color:blue;"> * </span>CSS</li>
                                    <li><span style="color:blue;"> * </span>JavaScript</li>
                                    <li><span style="color:blue;"> * </span>Connecting Front-End and Back-End</li>
                                    <li><span style="color:blue;"> * </span>API Integration</li>
                                    <li><span style="color:blue;"> * </span>Full Stack Integration</li>
                                   
                                    
                                    
                                 </ul>
                                 <p>As a Java Full Stack Developer, you will acquire the skills to build complete web applications from scratch, handle both client-side and server-side development, and integrate various technologies to deliver end-to-end solutions. This broad knowledge base makes you a versatile developer capable of tackling complex projects in a variety of environments.</p>
                              </div>
                           </div>
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">What is Java Full Stack development?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              </svg> <i>Reading:</i>Java Full Stack development refers to the ability to work on both the front-end (client side) and back-end (server side) of a web application using Java and related technologies. It involves building user interfaces, managing databases, creating APIs, and integrating different components to deliver a complete application.</span>
                                             </div>
                                              <div class="right">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What are the prerequisites for joining the Java Full Stack course at Code Infinite?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>Prospective students may ask if they need prior programming experience, whether they need to be familiar with Java, or if the course starts with the basics and gradually progresses to more advanced topics.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">What is the duration of the course and the schedule at Code Infinite?</span>
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">Will there be hands-on experience or lab sessions at Code Infinite?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>Students are interested in understanding how much practical coding they will do, and whether there are lab sessions or hands-on exercises to apply the concepts learned in class.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">What is the success rate of students who have completed the Java Full Stack course at Code Infinite?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>Prospective students might ask about the track record of the course, including how many graduates have secured jobs in the field and any testimonials or success stories from former students.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span"> Can I attend a demo session or trial class before enrolling at Code Infinite?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Some students ask if they can participate in a demo session or trial class to get a sense of the teaching style and course content before making a commitment.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                              ...
                              <div class="tp-course-details-2-instructor d-flex">
                                 ...
                                 <div class="tp-course-details-2-instructor-content">
                                    ...
                                    <div class="tp-course-details-2-instructor-text">
                                       <p>Keerthana  is a proficient Java trainer with a strong foundation in programming languages and web development. With a keen interest in fostering a passion for coding, Keerthana brings a blend of practical experience and theoretical knowledge to his teaching.</p>
                           ...
                           <h4 class="tp-course-details-2-main-title">Teaching Pattern and Methodologies</h4>
                              <div class="tp-course-details-2-list">
                                 ...
                                 <h4 class="tp-course-details-2-main-title">Benefits of Java Full Stack</h4>
                                 <p>If you study a Java full-stack development course, you'll be well-prepared to work in several fields within the tech industry.</p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Software Development</li>
                                    <li><span style="color:blue;"> * </span>Mobile Applications</li>
                                    <li><span style="color:blue;"> * </span> Web Development</li>
                              ...
                              <h4 class="tp-course-details-2-main-title">Students Outcome</h4>
                                 ...
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Proficiency in Java Programming</li>
                                    <li><span style="color:blue;"> * </span>Object-Oriented Design Skills</li>
                                    <li><span style="color:blue;"> * </span>Problem-Solving Abilities</li>
                                    <li><span style="color:blue;"> * </span>Error Handling</li>
                                    <li><span style="color:blue;"> * </span> Development and Debugging Skills</li>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="java.php"><img class="course-pink" src="assets/img/gif/course2.jpg" alt=""></a>
                        </div>
                        ...
                        <div class="tp-course-btn">
                           <a href="java.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="j2ee.php"><img class="course-sky" src="assets/img/gif/J2EE.png" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           <div class="tp-course-tag mb-10">
                              <span>J2EE</span>
                           ...
                           <h4 class="tp-course-title">
                              <a href="j2ee.php">Java Advanced Topics</a>
                           </h4>
                           <div class="tp-course-rating d-flex align-items-end justify-content-between">
                              <div class="tp-course-rating-star">
                                 <p>5.0<span> /5</span></p>
                        ...
                        <div class="tp-course-btn">
                           <a href="j2ee.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="spring.php"><img class="course-lightblue" src="assets/img/gif/spring.png" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           <div class="tp-course-tag mb-10">
                           ...
                           <h4 class="tp-course-title">
                              <a href="spring.php">Java Springboot</a>
                           </h4>
                           <div class="tp-course-rating d-flex align-items-end justify-content-between">
                              <div class="tp-course-rating-star">
                                 <p>5.0<span> /5</span></p>
                        ...
                        <div class="tp-course-btn">
                           <a href="spring.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
               </div>
