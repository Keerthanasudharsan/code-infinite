...
?>
         ...
         <section class="tp-breadcrumb__area pt-25 pb-55 p-relative z-index-1 fix">
            <div class="tp-breadcrumb__bg" ></div>
            <div class="container">
               <div class="row align-items-center">
                  <div class="col-sm-12">
                     <div class="tp-breadcrumb__content">
                        <div class="tp-breadcrumb__list course-details mb-70">
                           <span style="color:white"><a href="index.html"><svg width="17" height="14" viewBox="0 0 17 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <span style="color:white;">Courses  / Web development</span>
                        </div>

                        <div class="tp-course-details-2-header">
                           <span class="tp-course-details-2-category">Web development</span>
                           <h3 class="tp-course-details-2-title text-white">Web development</h3>
                           <div class="tp-course-details-2-meta-wrapper d-flex align-items-center flex-wrap">
                              <div class="tp-course-details-2-meta ">
                                 <div class="tp-course-details-2-author d-flex align-items-center">
                                    ...
                                    <div class="tp-course-details-2-author-content">
                                       <span class="tp-course-details-2-author-designation text-light">Senior Software Trainer</span>
                                       <h3 class="tp-course-details-2-meta-title text-white"><a href="#">Dr. Mansoor Ahamad</a></h3>
                                    </div>
                                 </div>
                              </div>
                              <div class="tp-course-details-2-meta">
                                 <span class="tp-course-details-2-meta-subtitle text-light">Category</span>
                                 <h3 class="tp-course-details-2-meta-title text-white">Web development</h3>
                              </div>
                              <div class="tp-course-details-2-meta">
                                 <span class="tp-course-details-2-meta-subtitle text-light">Course Duration</span>
                                 <h3 class="tp-course-details-2-meta-title text-white">80 hours</h3>
                              </div>
                              <div class="tp-course-details-2-meta text-end">
                                 <div class="tp-course-details-2-meta-rating-wrapper">
                                    ...
                                    <span class="tp-course-details-2-meta-subtitle text-light">Review</span>
                                 </div>
                              </div>
                           </div>
                        </div>
        ...
        <section class="tp-course-details-2-area pt-50 pb-80">
            <div class="container">
               <div class="row">
                  <div class="col-lg-8">
                     <div class="tp-course-details-2-main-inner">
                        ...
                        <div class="tp-course-details-2-content">
                           <div id="info">
                              ...
                              <div class="tp-course-details-2-text mb-60">
                                 <div class="content">
                                    <p>
                                    Web development is the process of creating and maintaining websites or web applications that are accessible over the internet. It involves both front-end development, which focuses on the user interface and experience, and back-end development, which handles the server, database, and application logic. </p>
                                    <p> Front-end developers use technologies like HTML, CSS, and JavaScript to create visually appealing and responsive designs, while back-end developers work with server-side languages and frameworks to manage data, user authentication, and application functionality.  </p>
                                   <p>Together, these elements ensure that websites are not only visually engaging but also functional, secure, and scalable, catering to a wide range of user needs and business objectives. Web development is crucial in today’s digital world, where a strong online presence is essential for businesses, organizations, and individuals alike.
                                     </p>
                                 </div>
                              ...
                              <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>HTML & CSS</li>
                                    <li><span style="color:blue;"> * </span>JavaScript</li>
                                    <li><span style="color:blue;"> * </span>Responsive Design</li>
                                    <li><span style="color:blue;"> * </span>Front-End Frameworks</li>
                                    <li><span style="color:blue;"> * </span>Back-End Development</li>
                                    <li><span style="color:blue;"> * </span>Database Management</li>
                                    <li><span style="color:blue;"> * </span>APIs and Web Services</li>
                                    <li><span style="color:blue;"> * </span>Version Control with Git</li>
                                    <li><span style="color:blue;"> * </span>Web Hosting and Deployment</li>
                                    <li><span style="color:blue;"> * </span>Security Best Practices</li>
                                    
                                    
                                 </ul>
                                 <p>By the end of the course, you will have the skills and knowledge to build and maintain modern, responsive, and dynamic websites or web applications, preparing you for a career as a front-end developer, back-end developer, or full-stack developer.</p>
                              </div>
                           </div>
                                 ...
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">What prerequisites do I need before enrolling in a Web Development course?</span>
                                      ...
                                      <div id="panelsStayOpen-collapseOne" class="accordion-collapse collapse show"          aria-labelledby="panelsStayOpen-headingOne">
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M1 7.4C1 4.38301 1 2.87452 1.99584 1.93726C2.99167 1 4.59445 1 7.8 1H8.41818C11.0271 1 12.3316 1 13.2375 1.63827C13.4971 1.82114 13.7275 2.03802 13.9218 2.28231C14.6 3.13494 14.6 4.36269 14.6 6.81818V8.85455C14.6 11.2251 14.6 12.4104 14.2249 13.357C13.6217 14.8789 12.3463 16.0793 10.7293 16.6469C9.7235 17 8.46415 17 5.94545 17C4.5062 17 3.78657 17 3.21182 16.7982C2.28783 16.4739 1.559 15.7879 1.21437 14.9183C1 14.3773 1 13.7 1 12.3455V7.4Z" stroke="#4F5158" stroke-width="1.2" stroke-linejoin="round" />
                                                <path d="M14.6016 9C14.6016 10.4728 13.4077 11.6667 11.9349 11.6667C11.4023 11.6667 10.7743 11.5733 10.2565 11.7121C9.79635 11.8354 9.43695 12.1948 9.31366 12.6549C9.1749 13.1728 9.26823 13.8007 9.26823 14.3333C9.26823 15.8061 8.07432 17 6.60156 17" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Basic computer literacy is generally required. While prior programming experience is helpful, it is not mandatory, as most courses start with the basics of HTML, CSS, and JavaScript.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                                     <path d="M3.00391 5.99976V4.49982C3.00391 2.01742 3.75388 0 7.50373 0C11.2536 0 12.0036 2.01742 12.0036 4.49982V5.99976" />
                                                   </mask>
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What topics will be covered in the Web Development course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> The Web Development course at Code Infinite will cover topics such as HTML, CSS, JavaScript, responsive design, front-end frameworks, back-end development, databases, APIs, version control with Git, web hosting, and security best practices. This comprehensive curriculum is designed to equip students with the skills needed to build and maintain modern web applications.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">How long is the Web Development course, and what is the format?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> The duration of the Web Development course at Code Infinite typically ranges from a few weeks to several months, depending on the intensity and format. It can be offered online, in-person, or as a hybrid of both, providing flexibility to accommodate different learning preferences.
                                               </span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                           ...
                           <div id="curriculum" class="pt-70 mt-5">
                              <!-- <h4 class="tp-course-details-2-main-title">Course Curriculum</h4> -->
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">Will I receive any certification upon completion of the course?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Yes, Code Infinite provides a certificate of completion after successfully finishing the Web Development course, which can enhance your resume and career prospects.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What career opportunities can I pursue after completing the Web Development course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              Graduates can pursue roles such as Front-End Developer, Back-End Developer, Full-Stack Developer, Web Designer, or Web Administrator in various industries, including tech, e-commerce, and digital marketing.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">Is there any placement assistance provided after the course?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Code Infinite provides 100% placement support, ensuring you are well-prepared to secure a position in the web development field.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">Will I work on real-world projects during the course?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Yes, the Web Development course at Code Infinite typically includes hands-on projects where you will design and develop complete websites or web applications, providing practical experience that mirrors professional web development work.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">Will the course cover both front-end and back-end development?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>Yes, a comprehensive web development course typically covers both front-end (client-side) and back-end (server-side) development, providing a well-rounded understanding of how web applications function.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">What kind of projects will I work on during the course?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i> Projects may include building personal portfolios, e-commerce sites, blogs, content management systems, and other web applications that showcase your skills and creativity.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                           ...
                           <div id="instructors" class="pt-100">
                              ...
                              <div class="tp-course-details-2-instructor d-flex">
                                 ...
                                 <div class="tp-course-details-2-instructor-content">
                                    <h5> Backiya Lakshmi  </h5>
                                  
                                    <span class="pre">Java and Web Development Trainer</span>
                                    ...
                                    <div class="tp-course-details-2-instructor-text">
                                       <p>Backiya Lakshmi  is a proficient Java trainer with a strong foundation in programming languages and web development. With a keen interest in fostering a passion for coding,Backiya Lakshmi  brings a blend of practical experience and theoretical knowledge to his teaching.</p>
                                      
                                       <h5>Skills</h5>
                                       <p>- Programming Languages: Java, C, C++</p>
                                       <p>- Web Development: HTML, CSS, JavaScript</p>
                                       <p>- Frameworks: Spring Framework (Java)</p>
                                    </div>
                                
                                 </div>
                              </div>
                           </div>
                           <h4 class="tp-course-details-2-main-title">Teaching Pattern and Methodologies</h4>
                              <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Theoretical explanations with examples</li>
                                    <li><span style="color:blue;"> * </span> Practical coding exercises during class.</li>
                                    <li><span style="color:blue;"> * </span> Assignments</li>
                                    <li><span style="color:blue;"> * </span>Quizzes and Tests</li>
                                    <li><span style="color:blue;"> * </span> Discussion Forums</li>
                                    <li><span style="color:blue;"> * </span> Feedback Mechanisms</li>
                                    <li><span style="color:blue;"> * </span>Project-Based Learning</li>
                                    <li><span style="color:blue;"> * </span> Flipped Classroom</li>
                                   
                                    
                                 </ul>
                                  </div>
                                 <h4 class="tp-course-details-2-main-title">Benefits Data Science Course</h4>
                                 <p>Web development is used across various sectors to create, enhance, and maintain online presences and applications.</p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Business Websites</li>
                                    <li><span style="color:blue;"> * </span>E-Commerce Platforms</li>
                                    <li><span style="color:blue;"> * </span> Blogs and Content Management Systems (CMS)</li>
                                    <li><span style="color:blue;"> * </span>Social Media Sites</li>
                                    <li><span style="color:blue;"> * </span> Web Applications</li>
                                    <li><span style="color:blue;"> * </span> Educational Platforms</li>
                                    <li><span style="color:blue;"> * </span>Portfolio Websites</li>
                                    <li><span style="color:blue;"> * </span>Entertainment and Media</li>
                                    <li><span style="color:blue;"> * </span>Healthcare</li>
                                    <li><span style="color:blue;"> * </span>Government and Non-Profit Organizations</li>
                                   
                                    
                                 </ul>
                              </div>
                              <h4 class="tp-course-details-2-main-title">Students Outcome</h4>
                                 <p>If you completed this course what will you gain from this Web development course.</p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Proficiency in Web Technologies</li>
                                    <li><span style="color:blue;"> * </span>Front-End Development Skills</li>
                                    <li><span style="color:blue;"> * </span>Back-End Development Skills</li>
                                    <li><span style="color:blue;"> * </span>Database Management</li>
                                    <li><span style="color:blue;"> * </span>Version Control Proficiency</li>
                                    <li><span style="color:blue;"> * </span>Web Hosting and Deployment Knowledge</li>
                                    <li><span style="color:blue;"> * </span>Security Best Practices</li>
                                    <li><span style="color:blue;"> * </span>Problem-Solving and Debugging Skills</li>
                                    <li><span style="color:blue;"> * </span>Project Experience</li>
                                    <li><span style="color:blue;"> * </span>Career Readiness</li>
                           ...
                           <div class="tp-course-details-2-review-reply-wrap">
                              <div class="tp-course-details-2-review-item-reply">
                                 ...
                                 <p>I am Tamilvannan, I have completed frontend Web development course at CodeInfinite. Trainers explained each and every concept very clearly. Which is easily understandable to me and the staffs are very friendly. " Code infinite is the Best institute in Coimbatore"</p>
                              ...
                              <div class="tp-course-details-2-review-item-reply">
                                 <div class="tp-course-details-2-review-top d-flex">
                                    ...
                                    <div class="tp-course-details-2-review-content">
                                       <h4>dhayabari bakthavachalam</h4>
                                       <div class="tp-course-details-2-review-star">
                                          <span><svg width="13" height="12" viewBox="0 0 13 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                                             <path d="M10.0534 7.46476C9.88979 7.62328 9.81464 7.85253 9.8519 8.07736L10.4133 11.1845C10.4607 11.4479 10.3495 11.7144 10.1291 11.8666C9.91316 12.0245 9.62581 12.0434 9.39024 11.9171L6.59317 10.4582C6.49591 10.4065 6.38792 10.3787 6.2774 10.3755H6.10625C6.04689 10.3844 5.98879 10.4033 5.93574 10.4324L3.13803 11.8982C2.99972 11.9676 2.8431 11.9923 2.68964 11.9676C2.31577 11.8969 2.06631 11.5407 2.12757 11.1649L2.68964 8.05778C2.7269 7.83106 2.65174 7.60054 2.48818 7.4395L0.207697 5.22912C0.0169731 5.04408 -0.0493383 4.76621 0.0378138 4.51549C0.12244 4.2654 0.338425 4.08289 0.59925 4.04184L3.73799 3.5865C3.97671 3.56187 4.18638 3.41661 4.29374 3.20189L5.67681 0.366291C5.70965 0.303138 5.75196 0.245036 5.80311 0.195776L5.85995 0.151569C5.88963 0.118729 5.92374 0.0915728 5.96163 0.069469L6.03047 0.0442076L6.13783 0H6.40371C6.64116 0.0246299 6.8502 0.166726 6.95946 0.378922L8.36084 3.20189C8.46188 3.4084 8.65829 3.55176 8.88501 3.5865L12.0238 4.04184C12.289 4.07973 12.5107 4.26287 12.5984 4.51549C12.6812 4.76873 12.6098 5.04661 12.4153 5.22912L10.0534 7.46476Z" fill="#FFB21D" />
                                             </svg></span>
                                 ...
                                 <p>Code Infinite is one of the best Institute I have seen for getting trained in programming languages and IT oriented concepts. Teaching methodology is very good, they make us to think for each and every concepts which made me understand every topics in my course.Mam also helped me to get cleared of my doubts. They also conduct many workshops and seminar which is very useful.</p>
                  ...
                  <div class="col-lg-4">
                     <div class="tp-course-details-2-widget">
                        <div class="tp-course-details-2-widget-thumb p-relative">
                           <img src="assets/img/course/details/course.jpg" alt="">
                           <a class="popup-video" href="https://www.youtube.com/watch?v=EW4ZYb3mCZk&amp;t=1s"><span><svg width="14" height="18" viewBox="0 0 14 18" fill="none" xmlns="http://www.w3.org/2000/svg">
               ...
               <div class="row">
                  <div class="col-lg-12">
                     <div class="tp-course-details-2-related-heading pt-80">
                        ...
                        <p>16+ unique course we provide</p>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="react.php"><img class="course-pink" src="assets/img/gif/mern.png" alt=""></a>
                        </div>
                        ...
                        <div class="tp-course-btn">
                           <a href="react.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="frontend.php"><img class="course-sky" src="assets/img/gif/php.jpg" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           <div class="tp-course-tag mb-10">
                              <span>php</span>
                           ...
                           <h4 class="tp-course-title">
                              <a href="frontend.php">Frontend/Php</a>
                           </h4>
                           <div class="tp-course-rating d-flex align-items-end justify-content-between">
                              <div class="tp-course-rating-star">
                                 <p>5.0<span> /5</span></p>
                        ...
                        <div class="tp-course-btn">
                           <a href="frontend.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6">
                     <div class="tp-course-item p-relative fix mb-30">
                        ...
                        <div class="tp-course-thumb">
                           <a href="testing.php"><img class="course-lightblue" src="assets/img/gif/softwaretesting1.jpg" alt=""></a>
                        </div>
                        <div class="tp-course-content">
                           <div class="tp-course-tag mb-10">
                           ...
                           <h4 class="tp-course-title">
                              <a href="testing.php">Software Testing</a>
                           </h4>
                           <div class="tp-course-rating d-flex align-items-end justify-content-between">
                              <div class="tp-course-rating-star">
                                 <p>5.0<span> /5</span></p>
                        ...
                        <div class="tp-course-btn">
                           <a href="testing.php">Preview this Course</a>
                        </div>
                     </div>
                  </div>
               </div>
