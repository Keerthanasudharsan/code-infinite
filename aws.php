                  ...
                  <div class="col-sm-12">
                     <div class="tp-breadcrumb__content">
                        <div class="tp-breadcrumb__list course-details mb-70">
                           ...
                           <span style="color:white;">Courses  / AWS</span>
                        </div>

                        <div class="tp-course-details-2-header">
                           <span class="tp-course-details-2-category">AWS</span>
                           <h3 class="tp-course-details-2-title text-white">AWS</h3>
                           <div class="tp-course-details-2-meta-wrapper d-flex align-items-center flex-wrap">
                              ...
                              <div class="tp-course-details-2-meta">
                                 ...
                                 <h3 class="tp-course-details-2-meta-title text-white">AWS</h3>
                              </div>
                              <div class="tp-course-details-2-meta">
                        ...
                        <div class="tp-course-details-2-content">
                           <div id="info">
                              ...
                              <div class="tp-course-details-2-text mb-60">
                                 <div class="content">
                                    <p>
                                    Amazon Web Services (AWS) is a comprehensive and widely adopted cloud computing platform offered by Amazon. It provides a vast array of cloud services, including computing power, storage options, networking, and databases, as well as advanced tools for machine learning, analytics, and artificial intelligence.</p>
                                    <p> AWS is designed to be scalable, secure, and cost-effective, making it suitable for businesses of all sizes—from startups to large enterprises. With its global infrastructure, AWS enables organizations to deploy applications and services quickly and efficiently, ensuring high availability and performance.</p>
                                   <p> Whether used for hosting websites, managing big data, or deploying enterprise applications, AWS is a powerful tool that supports innovation and growth in the digital age.
                                     </p>
                                 </div>
                              ...
                              <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Cloud Computing Fundamentals</li>
                                    <li><span style="color:blue;"> * </span>AWS Core Services</li>
                                    <li><span style="color:blue;"> * </span>Networking and Security</li>
                                    <li><span style="color:blue;"> * </span>Storage Solutions</li>
                                    <li><span style="color:blue;"> * </span>Databases</li>
                                    <li><span style="color:blue;"> * </span>Deploying and Managing Applications</li>
                                    <li><span style="color:blue;"> * </span>Monitoring and Optimization</li>
                                    <li><span style="color:blue;"> * </span>Automation and Infrastructure as Code (IaC)</li>
                                    <li><span style="color:blue;"> * </span>Security Best Practices</li>
                                    <li><span style="color:blue;"> * </span>DevOps and CI/CD</li>
                                    <li><span style="color:blue;"> * </span>Big Data and Analytics</li>
                                    <li><span style="color:blue;"> * </span>Machine Learning and AI</li>
                                   
                                    
                                    
                                 </ul>
                                 <p>By the end of the course, you will have a comprehensive understanding of AWS services and how to effectively use them to build, deploy, and manage applications in the cloud.</p>
                              </div>
                           </div>
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">What are the prerequisites for enrolling in an AWS course?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              </svg> <i>Reading:</i>While there are no strict prerequisites, having a basic understanding of networking concepts, operating systems (particularly Linux), and familiarity with cloud computing fundamentals can be beneficial. Some programming knowledge, especially in languages like Python or Java, may also help but is not mandatory for beginner-level courses.</span>
                                             </div>
                                              <div class="right">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What topics will be covered in the AWS course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>The course will cover a wide range of topics including AWS core services like EC2, S3, RDS, and VPC; networking and security configurations; deploying and managing applications; AWS management tools; DevOps practices using AWS; and best practices for cost optimization and security. Advanced courses may also delve into machine learning services, big data analytics, and serverless architectures.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">How long is the AWS course, and what is the mode of instruction?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>The duration of the course at Code Infinite typically ranges from 4 to 12 weeks, depending on the level (beginner, intermediate, advanced) and intensity of the program. Instruction modes can include in-person classroom sessions, live online classes, or a blend of both to accommodate different learning preferences and schedules.
                                               </span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What career opportunities can I pursue after completing the AWS course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                              ...
                                              Completing the AWS course opens up various career paths including Cloud Architect, Cloud Developer, DevOps Engineer, Systems Administrator, and Cloud Consultant. AWS skills are in high demand across industries, enhancing your employability and potential for career advancement.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                              ...
                              <div class="tp-course-details-2-faq">
                                 <div class="accordion" id="accordionPanelsStayOpenExample">
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingOne">
                                        <button class="accordion-button d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseOne" aria-expanded="false" aria-controls="panelsStayOpen-collapseOne">
                                          <span class="span">Do you provide any hands-on experience or practical projects during the course?</span>
                                        ...
                                        <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>Yes, the course at Code Infinite includes multiple hands-on labs and real-world projects that allow you to apply the concepts learned. You will work on setting up and managing AWS infrastructure, deploying applications, and implementing security measures, which will help build a strong practical understanding and a portfolio to showcase to potential employers.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingTwo">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseTwo" aria-expanded="false" aria-controls="panelsStayOpen-collapseTwo">
                                          <span class="span">What resources or materials will be provided during the course?</span>
                                      ...
                                      <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>Students will have access to comprehensive study materials including lecture slides, tutorials, reference guides, and recorded sessions. Additionally, access to AWS Free Tier accounts will be provided for hands-on practice. Supportive resources like discussion forums and mentorship from experienced instructors are also available.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                                    ...
                                    <div class="accordion-item">
                                      <h2 class="accordion-header" id="panelsStayOpen-headingThree">
                                        <button class="accordion-button collapsed d-flex justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#panelsStayOpen-collapseThree" aria-expanded="false" aria-controls="panelsStayOpen-collapseThree">
                                          <span class="span">How will I be assessed during the course?</span>
                                         ...
                                         <div class="accordion-body">
                                          ...
                                          <div class="tp-course-details-2-faq-item d-flex justify-content-between">
                                             <div class="left"><span> <svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M4.60156 5H10.2016" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M4.60156 8.2002H7.00156" stroke="#4F5158" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" />
                                              </svg> <i>Reading:</i>Assessment methods may include quizzes, assignments, practical projects, and a final exam or capstone project that demonstrates your understanding and application of the course material.</span>
                                             </div>
                                              <div class="right">
                                                <span><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                   <mask   fill="white">
                           ...
                           <div id="instructors" class="pt-100">
                              ...
                              <div class="tp-course-details-2-instructor d-flex">
                                 ...
                                 <div class="tp-course-details-2-instructor-content">
                                    <h5> Dr. Mansoor Ahamad R </h5>
                                    <span class="pre">Senior Programming Instructor</span>
                                    ...
                                    <div class="tp-course-details-2-instructor-text">
                                       <p>Dr. Mansoor Ahamad R is a highly accomplished senior programming instructor with over 11 years of experience in the IT industry and training. Holding a rich academic background, including a Master of Computer Applications (M.C.A.), Master of Philosophy (M.Phil.), and Doctorate (Ph.D.), Dr. Mansoor possesses a deep understanding of computer science principles and a passion for sharing his knowledge with others.</p>
                                      
                                       <h5>Skills</h5>
                                       <p>- Programming Languages: Java, Python, C, C++</p>
                                       <p>- Frameworks & Technologies: J2EE, Android, Frontend Development</p>
                                       <p>- Databases: MySQL</p>
                                       <p>- Full Stack Development: HTML, CSS, JavaScript</p>
                                    </div>
                           ...
                           <h4 class="tp-course-details-2-main-title">Teaching Pattern and Methodologies</h4>
                              <div class="tp-course-details-2-list">
                                 ...
                                 <h4 class="tp-course-details-2-main-title">Benefits of Aws Course</h4>
                                 <p>AWS (Amazon Web Services) is a versatile cloud platform used across various sectors for multiple purposes. </p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Cloud Hosting</li>
                                    <li><span style="color:blue;"> * </span>Data Storage and Backup</li>
                                    <li><span style="color:blue;"> * </span>Big Data Processing</li>
                                    <li><span style="color:blue;"> * </span>Application Development and Deployment</li>
                                    <li><span style="color:blue;"> * </span>DevOps Automation</li>
                                    <li><span style="color:blue;"> * </span>Machine Learning and AI</li>
                                    <li><span style="color:blue;"> * </span>Global Content Delivery</li>
                                    <li><span style="color:blue;"> * </span>Disaster Recovery</li>
                                    <li><span style="color:blue;"> * </span>Internet of Things (IoT)</li>
                                    <li><span style="color:blue;"> * </span>Enterprise IT</li>
                                   
                                    
                                 </ul>
                              </div>
                              <h4 class="tp-course-details-2-main-title">Students Outcome</h4>
                                 <p>If you completed this course what will you gain from this Aws course.</p>
                                 <div class="tp-course-details-2-list">
                                 <ul>
                                    <li ><span style="color:blue;"> * </span>Proficiency in Cloud Computing</li>
                                    <li><span style="color:blue;"> * </span>Hands-on Experience</li>
                                    <li><span style="color:blue;"> * </span>AWS Certification Preparation</li>
                                    <li><span style="color:blue;"> * </span>Job-Ready Skills</li>
                                    <li><span style="color:blue;"> * </span>Problem-Solving Abilities</li>
                                    <li><span style="color:blue;"> * </span>Portfolio Development</li>
                                    <li><span style="color:blue;"> * </span>Understanding of Best Practices</li>
                                    <li><span style="color:blue;"> * </span>Networking Opportunities</li>
                                    <li><span style="color:blue;"> * </span>Career Advancement</li>
                                    <li><span style="color:blue;"> * </span>Lifelong Learning</li>
                           ...
                           <div class="tp-course-details-2-review-reply-wrap">
                              <div class="tp-course-details-2-review-item-reply">
                                 ...
                                 <p>CI institute very useful for students, professionals and job seekers good training in coimbatore and very low cost compared to others. Experience peoples are taking classes. Best training institute to get more knowledge in Coimbatore.
                                 </p>
                              ...
                              <div class="tp-course-details-2-review-item-reply">
                                 ...
                                 <p>It was a wonderful place to gain knowledge....with the wonderful trainers....</p>
